 ...
 * are missing.
 * 
 * This is a JavaScript module (not TypeScript) to avoid ESLint issues
 * when imported in next.config.js during the build process.
 */
...
export { validateEnvironmentOrThrow };
